//! Copied from https://github.com/borntyping/rust-simple_logger
...
/// See [this](struct.Logger.html#method.with_level)
...
/// See [this](struct.Logger.html#method.from_env)
#[deprecated(since = "1.8.0", note = "Please use the Builder pattern instead.")]
pub fn init_by_env() {
    Logger::from_env().init().unwrap()
}
